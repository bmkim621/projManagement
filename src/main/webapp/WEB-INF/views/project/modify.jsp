...
<section>
	<div class="modifyWrap">
		...
		<div class="alert alert-info">
  			<strong>MODIFY PROJECT:</strong>&nbsp;&nbsp;프로젝트를 수정합니다.
		</div>
		
		<div id="formWarp">	
			<form class="form-horizontal" action="modify?project_no=${map.project.project_no }" method="post" role="form" id="modifyForm">
